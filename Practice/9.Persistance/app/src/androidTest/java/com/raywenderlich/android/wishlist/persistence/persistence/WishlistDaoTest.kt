package com.raywenderlich.android.wishlist.persistence.persistence
...
class WishlistDaoTest {
    ...
    @Before
    fun initDb() {
        wishlistDatabase = Room.inMemoryDatabaseBuilder(InstrumentationRegistry.getInstrumentation().context, WishlistDatabase::class.java).build()
